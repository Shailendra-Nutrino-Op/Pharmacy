...
h2{
   text-align: center;  color: #ffa500;   text-shadow: 4px 4px 8px rgba(0, 0, 0, 0.3);
    padding: 0px;  font-family: 'Arial', sans-serif;font-size:25px;
}

.style {

    background-color: #77A8FD; /* Light gray button */
...
.style:hover {
            background-color: #3774DE; /* Dark gray button on hover */
...
.style1:hover {
            background-color: #E30B0B; /* Dark gray button on hover */
            color: #fff; /* White text on hover */
        }
  ...
  .menu{
    ...
    <ul class="menu-bar">
        ...
        <h:form id="form1">
        	...
        	<h2>
    <h:outputText value="UPDATE EQUIPMENTS"/>
</h2>
	...
	onkeypress="return isNumberKey(event)"></h:inputText><br/>
			<h:message for="form1:quantity" style="color:red;"/>
		<br />
	...
	<f:convertDateTime pattern="yyyy-MM-dd"/>
		...
		<h:message for="form1:mfgDate" style="color:red;"></h:message>
		<br />
...
<h:inputText id="price" value="#{price}" converterMessage="Please enter numeric only" styleClass="inputText"
    onkeypress="return isNumberKey(event)">
</h:inputText><br/>	      <h:message for="form1:price" style="color:red;" />
	      <br/>


      <h:commandButton action="#{medController.addEquipment(medId, medName, type, quantity, mfgDate ,expiryDate , price)}"
     ...
     <%--  <h:commandButton action="#{medController.addMedicines(medicines)}"
                             value="Update" styleClass="button5">
                             </h:commandButton>
         <h:messages id="globalMessages" globalOnly="true" layout="table" style="color: red; font-weight: bold" />   
          --%>
